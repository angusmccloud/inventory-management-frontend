...
export default function SuccessDisplay({
  ...
  return (
    <div className="bg-surface rounded-lg shadow-lg p-8 text-center">
      {/* Success Icon */}
      <div className="mx-auto w-16 h-16 bg-secondary/10/30 rounded-full flex items-center justify-center mb-6">
        <svg
          className="w-10 h-10 text-secondary-contrast"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          aria-hidden="true"
      ...
      <div className="flex gap-4 justify-center mb-6">
        <button
          ...
          className="flex items-center justify-center gap-2 px-6 py-3 bg-error/10 hover:bg-error/10 disabled:bg-surface-elevated disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-colors min-w-[140px] min-h-[44px]"
        ...
        <button
          onClick={() => handleAdjustment(1)}
          disabled={isLoading}
          className="flex items-center justify-center gap-2 px-6 py-3 bg-secondary/10 hover:bg-secondary/10 disabled:bg-surface-elevated disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-colors min-w-[140px] min-h-[44px]"
