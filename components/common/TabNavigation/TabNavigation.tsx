  ...
  return (
    <>
      ...
      {(showDropdown || showAutoResponsive) && (
        <div className={cn(showAutoResponsive && 'md:hidden', 'w-full', className)}>
              ...
              className={cn(
                ...
                isActive
                  ? orientation === 'horizontal'
                    ...
                    : 'border-r-2 border-primary bg-primary/10 text-text-default'
                  : 'border-b-2 border-transparent text-text-secondary hover:border-border hover:text-text-default',
