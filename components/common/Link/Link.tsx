...
const getVariantStyles = (variant: LinkVariant): string => {
  const variants = {
    default:
      'text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 hover:underline focus:underline',
    primary:
      'text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 font-semibold underline',
    subtle:
      'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 no-underline',
  };
...
export const Link = React.forwardRef<HTMLAnchorElement, LinkProps>(
  (
    ...
    if (isExternal) {
      return (
        <a ref={ref} href={href} className={linkClasses} {...externalProps} {...props}>
          {children}
          {showExternalIcon && (
